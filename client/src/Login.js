			  ...
			  <div className="main-content">
			    ...
			    <div className="l-part">
			    	<form onSubmit={handleSubmit}>
						...
						<input type="text" placeholder="Enter email" value={email} onChange={e => setEmail(e.target.value)}  className="input-1" />
				      <div className="overlap-text">
						<input type="password" placeholder="Enter pass" value={password} onChange={e => setPassword(e.target.value)} className="input-2" />
				        <a href="#">Forgot?</a>
				      </div>
